...
public class CreateCommand extends AbstractCommand
{
    public CreateCommand() {
        super("create", "Allows you to create a group","§8§l» §b/grouplight create §7<name>", "grouplight.create", 2, Arrays.asList("create"), false);
    }
    ...
    public void execute(CommandSender sender, Command cmd, String[] args) {
        ...
        if(Main.getGroupLight().isExist(name)){
            sender.sendMessage("§cThis GroupLight already exists");
            return;
        }
